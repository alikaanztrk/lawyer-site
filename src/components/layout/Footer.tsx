        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="text-2xl font-bold mb-4">
              <span className="text-amber-400">Av.</span> Işıl Bengisu Akpınar
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/hizmetlerimiz/sigorta-hukuku" className="text-gray-300 hover:text-amber-400 transition-colors text-sm">Sigorta Hukuku</Link></li>
              <li><Link href="/hizmetlerimiz/ceza-hukuku" className="text-gray-300 hover:text-amber-400 transition-colors text-sm">Ceza Hukuku</Link></li>
              <li><Link href="/hizmetlerimiz/is-hukuku" className="text-gray-300 hover:text-amber-400 transition-colors text-sm">İş Hukuku</Link></li>
              <li><Link href="/hizmetlerimiz/ticaret-hukuku" className="text-gray-300 hover:text-amber-400 transition-colors text-sm">Ticaret Hukuku</Link></li>
              <li><Link href="/hizmetlerimiz/aile-hukuku" className="text-gray-300 hover:text-amber-400 transition-colors text-sm">Aile Hukuku</Link></li>
              <li><Link href="/hizmetlerimiz" className="text-amber-400 hover:text-amber-300 transition-colors text-sm font-medium">Tüm Hizmetler →</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-slate-800 rounded-xl">
              ...
              <div className="mt-3 pt-3 border-t border-slate-700">
                <p className="text-amber-400 text-xs font-medium">7/24 Acil: 
                  <a href="tel:+905331234567" className="ml-1 hover:text-amber-300">
                    +90 533 123 45 67
                  </a>
                </p>
              </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-sm mb-4 md:mb-0">
              ...
              <div className="flex items-center text-gray-400">
                ...
                <a 
                  ...
                  className="ml-1 text-amber-400 hover:text-amber-300 transition-colors font-medium inline-flex items-center"
                >
                  Ali Kaan Öztürk
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-end">
              ...
              <Link href="/blog" className="text-gray-300 hover:text-amber-400 text-sm transition-colors">
                Blog
              </Link>
            </div>
          </div>
