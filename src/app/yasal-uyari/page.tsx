...
export const metadata: Metadata = {
  title: 'Yasal Uyarı | Av. Işıl Bengisu Akpınar',
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">1. Site Sahibi ve İletişim Bilgileri</h2>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">2. Web Sitesinin Amacı</h2>
            <p className="text-slate-700 leading-relaxed">
              Bu web sitesi, Av. Işıl Bengisu Akpınar&apos;ın sunduğu avukatlık hizmetleri hakkında bilgi vermek, 
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">3. İçerik ve Bilgi Sorumlulukları</h2>
            
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.1 İçerik Doğruluğu</h3>
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.2 Hukuki Tavsiye</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.3 Güncellik</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">4. Kullanım Şartları</h2>
            
            <h3 className="text-xl font-semibold text-slate-800 mb-3">4.1 Uygun Kullanım</h3>
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">4.2 Yasak Faaliyetler</h3>
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">5. Telif Hakları ve Fikri Mülkiyet</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">6. Sorumluluk Reddi</h2>
            
            <h3 className="text-xl font-semibold text-slate-800 mb-3">6.1 Genel Sorumluluk</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">6.2 Teknik Sorunlar</h3>
            <p className="text-slate-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">7. Üçüncü Taraf Bağlantıları</h2>
            <p className="text-slate-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">8. Veri ve Gizlilik</h2>
            <p className="text-slate-700 leading-relaxed">
              Kişisel verilerinizin işlenmesi hakkında detaylı bilgi için 
              <a href="/gizlilik-politikasi" className="text-slate-600 hover:underline"> Gizlilik Politikası</a> ve 
              <a href="/kvkk" className="text-slate-600 hover:underline"> KVKK Aydınlatma Metni</a>&apos;ni inceleyiniz.
            </p>
          </section>

          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">9. Değişiklikler</h2>
            <p className="text-slate-700 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">10. Uygulanacak Hukuk ve Yetki</h2>
            <p className="text-slate-700 leading-relaxed">
